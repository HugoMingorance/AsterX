...
public class TitleScreenPanel : ActiveOnlyDuringSomeGameStates {
    ...
    public enum eTitleScreenPanelState {
    ...
    [SerializeField]
    private eTitleScreenPanelState state = eTitleScreenPanelState.none;
    ...
    eTitleScreenPanelState nextState;
    ...
    override public void Awake () {
        ...
        SetState(eTitleScreenPanelState.idle);
    ...
    protected override void DetermineActive()
    {
        ...
        if (AsteraX.GAME_STATE == AsteraX.eGameState.gameOver) {
            ...
            SetState(eTitleScreenPanelState.fadeIn);
        }
    }

    void SetState(eTitleScreenPanelState newState) 
    {
        stateStartTime = realTime;
        
        switch (newState) {
            case eTitleScreenPanelState.idle:
            ...
            case eTitleScreenPanelState.fadeIn:
                ...
                nextState = eTitleScreenPanelState.fadeIn2;
                break;
                
            case eTitleScreenPanelState.fadeIn2:
                // Set initial state
                ...
                nextState = eTitleScreenPanelState.fadeIn3;
                break;
                
            case eTitleScreenPanelState.fadeIn3:
                // Set initial state
                img.color = Color.black;
                ...
                // Set timiing and advancement
                stateDuration = fadeTime*0.2f;
                nextState = eTitleScreenPanelState.display;
                break;
                
            case eTitleScreenPanelState.display:
                stateDuration = 999999; // A very long time
                nextState = eTitleScreenPanelState.none;
    ...
    void Update () {
        if (state == eTitleScreenPanelState.none) {
            return;
        }
        ...
        float n;
        switch (state) {
            case eTitleScreenPanelState.fadeIn: // Background
                img.color = new Color(0,0,0,u);
                break;
                
            case eTitleScreenPanelState.fadeIn2: // LevelText
                n = LevelTextYScaleEffect(u);
                levelRT.localScale = new Vector3(1, n, 1);
                break;
                
            case eTitleScreenPanelState.fadeIn3: // InfoText
                n = u*u;
